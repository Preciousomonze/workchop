...
return array(
    'Curl' => $vendorDir . '/pp/curl/Curl.class.php',
    'Dater' => $vendorDir . '/pp/date/Date.class.php',
    ...
    'Names' => $vendorDir . '/pp/Filter/Names.class.php',
    'PHPMailer' => $vendorDir . '/phpmailer/phpmailer/class.phpmailer.php',
    'PHPMailerOAuth' => $vendorDir . '/phpmailer/phpmailer/class.phpmaileroauth.php',
    'PHPMailerOAuthGoogle' => $vendorDir . '/phpmailer/phpmailer/class.phpmaileroauthgoogle.php',
    'POP3' => $vendorDir . '/phpmailer/phpmailer/class.pop3.php',
    'PekkyRecaptcha' => $vendorDir . '/pp/recaptcha/Recaptcha.class.php',
    'ReCaptcha' => $vendorDir . '/pp/recaptcha/Recaptcha.class.php',
    'ReCaptchaResponse' => $vendorDir . '/pp/recaptcha/Recaptcha.class.php',
    'RegMail' => $vendorDir . '/pp/mail/RegMail.class.php',
    'SMTP' => $vendorDir . '/phpmailer/phpmailer/class.smtp.php',
    'Session' => $vendorDir . '/pp/session/Session.class.php',
    '_404Message' => $vendorDir . '/pp/_404/Message.class.php',
    'ntlm_sasl_client_class' => $vendorDir . '/phpmailer/phpmailer/extras/ntlm_sasl_client.php',
    'phpmailerException' => $vendorDir . '/phpmailer/phpmailer/class.phpmailer.php',
    'pp\\DB\\DBCon' => $vendorDir . '/pp/DB/DBCon.php',
    'pp\\DB\\Query' => $vendorDir . '/pp/DB/Query.php',
);
